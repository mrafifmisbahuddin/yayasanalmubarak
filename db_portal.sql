...
(5, 6, 'Komarudin komar', 'komarftik@gmail.com', 'jos', '2019-06-21', '');
...
INSERT INTO `tbl_student` (`id_student`, `nisn`, `nama`, `tanggal`, `jk`, `jurusan`, `angkatan`, `alamat`, `status`) VALUES
(1, 'ko', 'Multi Media', '2009-01-01', 'Laki - Laki', 'RPL', '1', 'Damc', 'Aktif'),
(2, 'a', 'Multi Media', '2009-01-01', 'Laki - Laki', 'TKJ', '1', 'Damc', 'Aktif'),
(3, 's', 'Multi Media', '2009-01-01', 'Laki - Laki', 'RPL', '1', 'Damc', 'Aktif'),
(4, 's', 'Multi Media', '2009-01-01', 'Laki - Laki', 'TKJ', '1', 'Damc', 'Aktif');
...
INSERT INTO `tbl_tags` (`id_tags`, `gambar`, `judul_tags`, `tanggal`) VALUES
(4, '5d0f6cfba356b.jpg', 'Logo SMK Dan Jurusan', '2019-06-23'),
(5, '5d4a25c60c62e.png', 'kjdsk', '2019-08-06');
...
--
ALTER TABLE `tbl_tags`
  MODIFY `id_tags` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
